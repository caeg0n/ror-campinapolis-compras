Rails.application.routes.draw do
  ...
  #resources :rankings
	...
	post 'validate_device', to: "organization_devices#validate_device", defaults: {format: :json}
	post 'contacts', to: "contacts#create", defaults: { format: :json }
	...
	put 'organization_state', to: "organizations#update_state", defaults: { format: :json }
	put 'organization_delivery_type', to: "organizations#update_organization_delivery_type", defaults: { format: :json }
	put 'update_fees', to: "organization_devices#update_fees", defaults: { format: :json }
	...
	get 'get_orders_by_organization/:uuid/:organization_id', to: "orders#get_orders_by_organization", defaults: { format: :json }
	...
	get 'organizations/:id', to: "organizations#show", defaults: { format: :json }
	...
	get 'search_product', to: "products#search", defaults: { format: :json }
